...
export default function Lunar() {
    ...
    return (
        <div>
            <section className="flex flex-col self-center pt-1 pb-3 w-full items-center border border-[#13492f]" style={{ backgroundColor: themeGreen }}>
                <div className="flex flex-row items-stretch justify-between items-center">
                    ...
                    <div className={`flex flex-col items-center flex-1 mx-2`}>
                        <div className={`flex flex-col items-center p-1 mt-1 text-xs text-center text-black bg-white ${commonWidthClass}`} style={{ color: themeGreen }}>
                            <strong className="text-[0.85rem]">甲辰年 &nbsp;九月十五</strong>
                        </div>
                        <div className={`flex flex-col items-center px-2 py-2 text-2xl text-center text-white whitespace-nowrap ${commonWidthClass}`} style={{ backgroundColor: themeGreen }}>
                            <p className="font-black text-stroke-1 text-stroke-white">初一十五</p>
                        </div>
                    </div>
                    <div className="flex flex-col items-center text-center whitespace-nowrap mr-2">
                        <div className={`mt-1 p-1 text-xs text-black bg-white ${commonWidthClass}`} style={{ color: themeGreen }}>
                            <strong className="text-[0.85rem]">WEDNESDAY</strong>
                        </div>
                        <div className={`px-2 py-2 text-2xl text-white ${commonWidthClass}`} style={{ backgroundColor: themeGreen }}>
                            <strong className="text-stroke-1 text-stroke-white">星期三</strong>
                        </div>
                    </div>
                    <div className="flex">
